...
$app->post('/api/USPS/getProofOfDeliveryCopy', function ($request, $response) {
    
    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['userId','trackId','mpSuffix','mpDate','email','tableCode']);
