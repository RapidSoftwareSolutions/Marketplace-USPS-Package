...
$app->post('/api/USPS/setEmailForTrackingNotification', function ($request, $response) {
    
    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['userId','trackId','mpSuffix','mpDate','requestType','email']);
